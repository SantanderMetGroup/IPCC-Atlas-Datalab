...
def compute(nw, hist, ssp126, ssp245, ssp370, ssp585):
    ...
    mean_hist_1995_2014 = hist["t"].chunk({"member": 1, "time": -1}).sel(time=slice("19950101", "20141231")).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["time", "lat", "lon"])
    mean_hist_1850_1900 = hist["t"].chunk({"member": 1, "time": -1}).sel(time=slice("18500101", "19001231")).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["time", "lat", "lon"])

    mean_hist = hist["t"].chunk({"member": -1, "time": 1}).sel(time=slice("19500101", None)).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["member", "lat", "lon"])
    mean_ssp126 = ssp126["t"].chunk({"member": -1, "time": 1}).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["member", "lat", "lon"])
    mean_ssp245 = ssp245["t"].chunk({"member": -1, "time": 1}).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["member", "lat", "lon"])
    mean_ssp370 = ssp370["t"].chunk({"member": -1, "time": 1}).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["member", "lat", "lon"])
    mean_ssp585 = ssp585["t"].chunk({"member": -1, "time": 1}).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["member", "lat", "lon"])

    mean_spatial_hist = hist["t"].chunk({"member": -1, "time": 1}).sel(time=slice("19500101", None)).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["lat", "lon"])
    mean_spatial_ssp126 = ssp126["t"].chunk({"member": -1, "time": 1}).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["lat", "lon"])
    mean_spatial_ssp245 = ssp245["t"].chunk({"member": -1, "time": 1}).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["lat", "lon"])
    mean_spatial_ssp370 = ssp370["t"].chunk({"member": -1, "time": 1}).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["lat", "lon"])
    mean_spatial_ssp585 = ssp585["t"].chunk({"member": -1, "time": 1}).compute(num_workers=nw, scheduler="processes").weighted(weights).mean(["lat", "lon"])
